...
前面在 [EventBus设计与实现分析——特性介绍](http://www.jianshu.com/p/c7b6280dc18d)中介绍了EventBus的基本用法，及其提供的大多数特性的用法；在[EventBus设计与实现分析——订阅者的注册](http://www.jianshu.com/p/f33ed813ccfd) 中介绍了EventBus中订阅者注册的过程。这里就继续分析EventBus的代码，来了解其事件发布的过程。
